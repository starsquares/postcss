...
var init = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, readFileSync(join(process.cwd() + ".cache/package.json"), "utf8")];
            case 1:
                dir = _a.sent();
...
var search = function (name) { return __awaiter(void 0, void 0, void 0, function () {
    var path, file;
    return __generator(this, function (_a) {
        path = resolve(process.cwd(), "./.cache/" + name + ".json");
        try {
                    ...
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            decls.forEach(function (decl) {
                                ...
                                style_1.push(new Declaration({ prop: decl[0], value: decl[1] }));
                            });
